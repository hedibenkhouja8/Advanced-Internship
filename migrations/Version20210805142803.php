 ...
 */
final class Version20210805142803 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE licence ADD category_id INT NOT NULL');
        $this->addSql('ALTER TABLE licence ADD CONSTRAINT FK_1DAAE64812469DE2 FOREIGN KEY (category_id) REFERENCES category (id)');
        $this->addSql('CREATE INDEX IDX_1DAAE64812469DE2 ON licence (category_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_1DAAE64812469DE2 ON licence');
        $this->addSql('ALTER TABLE licence DROP category_id');
    }
}
